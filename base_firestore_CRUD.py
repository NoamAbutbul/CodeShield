...
class BaseDatastoreCRUD:
    ...
    def create_document(self, kind: str, doc_id: str, data: str) -> None:
    ...
    def read_document(self, kind: str, doc_id: str) -> dict or None:  # type: ignore
        ...
        Returns:
            dict: The data of the document if it exists, None otherwise.
        """
        key = self.__client.key(kind, doc_id)
    ...
    def read_all_documents(self, kind: str) -> dict:
